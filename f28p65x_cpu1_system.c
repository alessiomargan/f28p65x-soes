...
// Included Files
//
#include "f28p65x_cpu1_system.h"

//
// F28P65XCPU1_strcpy - String copy wrapper for compatibility with EtherCAT stack
...
//
// F28P65XCPU1_memcpy - Memory copy wrapper for compatibility with EtherCAT stack
//                     calls to "memcpy" to adjust for input size in bytes
//
void F28P65XCPU1_memcpy(void * __restrict destination, const void * __restrict source,
                       size_t length)
{
    //
...
//
// F28P65XCPU1_memset - Memory set wrapper for compatibility with EtherCAT stack
...
//
// F28P65XCPU1_memcpy - String copy wrapper for compatibility with EtherCAT stack
